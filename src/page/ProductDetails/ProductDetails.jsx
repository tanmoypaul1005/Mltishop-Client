...
import { iproduct1, iproduct2, iproduct3, iproduct4, iuser } from '../../Utility/Sources';
                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner bg-light">
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src={iproduct1} alt="Image"></img>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={iproduct2} alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={iproduct3} alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={iproduct4} alt="Image"/>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="media mb-4">
                                        <img src={iuser} alt="Image" className="img-fluid mr-3 mt-1" style={{width: "45px"}}/>
