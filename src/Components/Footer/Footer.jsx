...
import { ipayments } from '../../Utility/Sources';
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 mb-5">
                        ...
                        <div className="d-flex">
                            ...
                            <a className="btn btn-primary btn-square mr-2" href="/"><i className="fa-brands fa-facebook-f"></i></a>
        ...
        <div className="row border-top mx-xl-5 py-4" style={{borderColor: "rgba(256, 256, 256, .1) !important"}}>
            <div className="col-md-6 px-xl-0">
                <p className="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a className="text-primary" href="/">Multishop</a>. All Rights Reserved  
                </p>
            </div>
            <div className="col-md-6 px-xl-0 text-center text-md-right">
                <img className="img-fluid" src={ipayments} alt=""/>
            </div>
        </div>
    </div>
    );
